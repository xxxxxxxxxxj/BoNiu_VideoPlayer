package com.boniu.shipinbofangqi.mvp.view.activity.base;
...
import com.boniu.shipinbofangqi.util.ActivityListManager;
...
public abstract class BaseActivity<P extends BasePresenter> extends SwipeBackActivity {
     ...
     * @return
     */
    protected Animation shakeAnimation(int counts) {
