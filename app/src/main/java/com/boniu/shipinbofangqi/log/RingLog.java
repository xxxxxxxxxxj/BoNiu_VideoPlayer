package com.boniu.shipinbofangqi.log;
 ...
 * <ol>
 * <li>use RingLog.d(),you could print whether the method execute,and the default tag is current
 * class's name</li>
 * <li>use RingLog.d(msg),you could print log as before,and you could location the method with a
 * click in Android Studio Logcat</li>
 * <li>use RingLog.json(),you could print json string with well format automatic</li>
 * </ol>
 *
 * @author zhaokaiqiang
...
public class RingLog {
    ...
    private static final String TAG_DEFAULT = "RingLog";
